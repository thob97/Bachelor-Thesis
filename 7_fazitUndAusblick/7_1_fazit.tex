%\subsection{Fazit}
%Zusammenfassend ist eine Anwendung für einen CLI-Terminkalender entstanden, welche versucht die Lücke zwischen Terminal und Smartphone zu überbrücken, indem Sie auf die Stärken und Schwächen des PCs und Handys ausgelegt ist. 
%Dazu wurde sich vorerst überlegt was die Unterschiede und Stärken überhaupt sind. Darauf wurden sich für kalender Anwendungen allein überlegt welche Funktionen diese haben soll und nach den Stärken ausgesucht.
%
%Limitationen:
%Für schlagfertige ergebnisse nutzertest nötig
%Stärken und Schwächen von Handys sind lediglich vermutungen, könnten falsch gesammelt oder interpretiert (einige zu stark andere wichtige zu schwach) worden sein. Jedoch nicht sehr wahrscheinlich, da erkenntnisse sich auf mit Mustern auf Richtlinien überschneiden
%
%
%Zusammenfassung
	%Einleitung
