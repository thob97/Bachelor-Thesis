...
%
%
%Zusammenfassung: Um die stabilität der Anwendung sicherzustellen wurde für den Parser und die Datenbankverbindung automatische Rückfalltests benutzt, während die grafische Oberfläche manuell getestet wurde.
%Um eine gute Lesbarkeit des Quellcodes zu ermöglichen wurde modularizierung angewendet, Zugriffsmodifikatoren gesetzt und in einem einheitlichen Format kommentare geschrieben.
%
%
\subsubsection{Tests}
%Einleitung:
