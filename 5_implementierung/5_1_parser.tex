...
%%
%%Einleitung: Generell versucht sich möglichst immer an die Vorgaben der Doku zu halten, damit When nutzer ihre bereits bestehenden calendarfiles nicht anpassen müssen.
%Ziel war es ^, inwiefern dies gelang wird in folgenden Kapitel behandelt
%%Zusammenfassung:
%%
%%
