...
Um einen Überblick zu schaffen und zu vermitteln wie versucht wird sich an die Lösung des Problems heranzuarbeiten, enthält jeder Abschnitt zu Beginn eine kurze Einleitung über ihren Inhalt und dessen Relevanz.\newline%
%Was + Warum: Zusammenfassung für jeden Abschnitt -> Querlesen
Außerdem haben alle Abschnitte eine kurze Zusammenfassung. Darin werden wichtige Entscheidungen und Ergebnisse des Kapitels genannt. Das soll einen die Möglichkeit geben ganze Abschnitte oder sogar Kapitel überfliegen zu können und trotzdem die wichtigsten Aspekte und Resultate der Arbeit zu verstehen. Anders gesagt hilft diese Strukturentscheidung beim Querlesen.