...
%Was: Einstiegsaufwand
	...
	Bei Handys existiert dieser Aufwand hingegen nicht. %
		...
		So wird erstens davon ausgegangen, dass die meisten Nutzer ihr Handy immer bei sich tragen. Das liegt einerseits an der zuvor erwähnten Mobilität, [aber andererseits] auch in der \nameref{subsection:motivation} erwähnten Relevanz und Beliebtheit von Handys. %
		%Warum:
